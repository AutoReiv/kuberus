...
const DataTable: React.FC<{ clusterRoleBindings: ClusterRoleBinding[] }> = ({
  clusterRoleBindings,
}) => {
  ...
  const handleRowClick = (clusterRoleBindingName: any) => {
    router.push(`/dashboard/cluster-role-bindings/${clusterRoleBindingName}`);
  };
