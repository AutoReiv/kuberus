...
// HandleGetUserDetails handles requests for detailed information about a specific user.
func HandleGetUserDetails(c echo.Context, clientset *kubernetes.Clientset) error {
